=== WordPress PayPal ===
Contributors: naa986 and chalamministries
...
[WordPress PayPal](https://github.com/chalamministries/Palementor) plugin allows you to easily create PayPal Buy Now, Add to Cart, Donation or Subscription type buttons in Elementor!
...
In order to create a button, simply go to Elementor. Under the General widgets category, you will see a Paypal Button widget. Drag it to your canvas and configure the options!

== Installation ==

1. Go to the Add New plugins screen in your WordPress Dashboard
1. Click the upload tab
1. Browse for the plugin file (palementor.zip) on your computer
